...
class FileDiffComment(BaseModel):
    ...
    on_the_other_hand: str = Field(description="Try to find flaws in you previous logic. Is the principle actually violated?")
    is_violating_principle: bool = Field(description="True if the problem explicitly mentioned in the principle text? False if the problem is not explicitly described in the principle, but just a general code improvement suggestion.")
